...
#pragma merger(0,"/tmp/cil-nb8KE7wV.i","-Werror -W -Wall -O0 -g")
...
extern PLHashTable *PL_NewHashTable(PRUint32 numBuckets , PLHashNumber (*keyHash)(void const   *key ) ,
                                    PRIntn (*keyCompare)(void const   *v1 , void const   *v2 ) ,
                                    PRIntn (*valueCompare)(void const   *v1 , void const   *v2 ) ,
                                    PLHashAllocOps const   *allocOps , void *allocPriv ) ;
extern PLHashEntry *PL_HashTableAdd(PLHashTable *ht , void const   *key , void *value ) ;
extern PRBool PL_HashTableRemove(PLHashTable *ht , void const   *key ) ;
extern void *PL_HashTableLookup(PLHashTable *ht , void const   *key ) ;
extern PLHashNumber PL_HashString(void const   *key ) ;
extern PRIntn PL_CompareStrings(void const   *v1 , void const   *v2 ) ;
extern PRIntn PL_CompareValues(void const   *v1 , void const   *v2 ) ;
extern void assert_failed(char *file , unsigned int line , char const   *func , char *expr ) ;
...
#pragma merger(0,"/tmp/cil-Ze6uXf8I.i","-Werror -W -Wall -O0 -g")
...
#pragma merger(0,"/tmp/cil-5ZDpH2hd.i","-Werror -W -Wall -O0 -g")
...
#pragma merger(0,"/tmp/cil-HN2Nw7Fk.i","-Werror -W -Wall -O0 -g")
...
void print_cap_stats(void) 
{ 

  {
  printf((char const   * __restrict  )"capstats:  opens %5.0f    closes %5.0f   lifetime %.0f ms\n",
...
{ struct sockaddr_in caddr ;
  ...
  while (1) {
    ...
    if (g_spawn_on_demand) {
      ...
      tmp___0 = pthread_create(& thread, (pthread_attr_t const   *)(& attr), & thread_process_client,
                               (void *)c);
      if (tmp___0 < 0) {
        g_conn_fail ++;
        g_conn_active --;
...
{ struct sockaddr_in saddr ;
  ...
  if (g_spawn_on_demand) {
    tmp___5 = pthread_create(& thread___0, (pthread_attr_t const   *)((void *)0),
                             & thread_main_autospawn, (void *)s);
    if (tmp___5 < 0) {
    ...
    while (i < nthreads) {
      ...
      targs->id = i;
      targs->s = s;
      tmp___7 = pthread_create(& thread___1, (pthread_attr_t const   *)((void *)0),
                               & thread_main, (void *)targs);
      if (tmp___7 < 0) {
        perror("pthread_create");
      }
      i ++;
